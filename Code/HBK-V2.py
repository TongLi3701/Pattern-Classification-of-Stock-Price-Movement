...
target_num = 19
start_num = 2
[cluster_result,cluster_centroids,num_cluster] = hierarchical_based_Kmeans(data_set,start_num,target_num)
...
# print((calinski_harabaz_score_evaluation(data_set,Kmeans_result.labels_)))
