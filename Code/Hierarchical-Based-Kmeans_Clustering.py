...
[cluster_result,cluster_centroids,num_cluster] = hierarchical_based_Kmeans(data_set,5,10)

clusters_visualization(data_set,cluster_result,10)
for i in range (10):
    single_cluster_visualization(data_set,cluster_result,i)

# print(silhouette_score_evaluation(data_set,cluster_result))
#
# Kmeans_result = KMeans(n_clusters = 10).fit(data_set)
